...
ggsave(plot=p,"plots/ua_occ_ts.pdf",width=4*1.5,height=3*1.5,device=cairo_pdf)
ggsave(plot=p,"plots/ua_occ_ts.png",width=4*1.5,height=3*1.5,dpi=600)
ggsave(plot=p,"plots/ua_occ_ts.svg",width=4*1.5,height=3*1.5)
