...
labs(title="",subtitle = "Ukraine", caption = "Number of occurrences published by Ukraine before and during invasion.") +
...
scale = 5
ggsave(plot=p,"plots/ua_occ_ts_facet.pdf",width=4*scale,height=3*scale,device=cairo_pdf)
ggsave(plot=p,"plots/ua_occ_ts_facet.png",width=4*scale,height=3*scale,dpi=600)
ggsave(plot=p,"plots/ua_occ_ts_facet.svg",width=4*scale,height=3*scale)
